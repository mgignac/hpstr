...
vtxana = HpstrConf.Processor('vtxana', 'RecoilProcessor')

###############################
#   Processor Configuration   #
###############################
#Vertex Analysis
vtxana.parameters["debug"] = 2
...
# tell RecoilProcessor which ROOT branch to use for truth tracks
vtxana.parameters["truthTrackCollRoot"] = "Truth_KalmanTracks"

vtxana.parameters["sclusColl"]  = "SiClustersOnTrack" #for truth and track matching 
#vtxana.parameters["sclusColl"]  = "fspOnTrackHits"
