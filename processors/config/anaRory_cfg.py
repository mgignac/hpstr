...
track2 = HpstrConf.Processor('track2', 'TrackingProcessor')
...
svthits.parameters["hitCollRoot"] = 'SiClusters'#USED TO NOT HAVE "OnTrack"
...
track.parameters["doResiduals"] = 0 
track.parameters["trackResDataLcio"] = 'KFUnbiasRes'
track.parameters["resPlts"] = '/fs/ddn/sdf/group/hps/users/rodwyer1/sw/workinghpstr/analysis/plotconfigs/tracking/residuals.json'
track.parameters["resoutname"] = 'bingbong.root'
...
##Truth Tracks
#track2.parameters["debug"] = 0
#track2.parameters["trkCollLcio"] = 'KalmanFullTracksTruth'
#track2.parameters["trkCollRoot"] = 'KalmanFullTracksTruth'
...
sequence = [header, ecal, svthits, track, svthits, mcpart, rawsvt,  fsp]
#[header, track, svthits, rawsvt]                          
